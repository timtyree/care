...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "sources": [
            "/home/timothytyree/Documents/GitHub/care/notebooks/lib/measure/_find_tips_pbc_cy.pyx"
        ]
    },
 ...
 */
  ...
  /* "lib/measure/_find_tips_pbc_cy.pyx":198
 *     cdef list segments2 = []
 * 
 *     cdef bint use_mask = mask is not None             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "lib/measure/_find_tips_pbc_cy.pyx":199
 * 
 *     cdef bint use_mask = mask is not None
 *     cdef unsigned char square_case1 = 0             # <<<<<<<<<<<<<<
 *     cdef unsigned char square_case2 = 0
 ...
 */
  ...
  /* "lib/measure/_find_tips_pbc_cy.pyx":200
 *     cdef bint use_mask = mask is not None
 *     cdef unsigned char square_case1 = 0
 *     cdef unsigned char square_case2 = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "lib/measure/_find_tips_pbc_cy.pyx":210
 ...
 */
  ...
  /* "lib/measure/_find_tips_pbc_cy.pyx":217
 * 
 ...
 */
  ...
  /* "lib/measure/_find_tips_pbc_cy.pyx":224
 *     cdef double cmax = np.around(width-0.5,2)
 * 
 *     for r0 in range(height):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    ...
    /* "lib/measure/_find_tips_pbc_cy.pyx":225
 * 
 *     for r0 in range(height):
 *         for c0 in range(width):             # <<<<<<<<<<<<<<
 *             # jumped_ul = False
 ...
 */
    ...
    for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
      ...
      /* "lib/measure/_find_tips_pbc_cy.pyx":229
 *             # jumped_lr = False
 * 
 *             r1, c1 = r0 + 1, c0 + 1             # <<<<<<<<<<<<<<
 *             if r1 >= height:
 ...
 */
      ...
      /* "lib/measure/_find_tips_pbc_cy.pyx":233
 *                 r1 = 0
 *                 # jumped_ul = True
 *             if c1 >= width:             # <<<<<<<<<<<<<<
 *                 c1 = 0
 ...
 */
      ...
      if (__pyx_t_15) {
        ...
        /* "lib/measure/_find_tips_pbc_cy.pyx":234
 *                 # jumped_ul = True
 *             if c1 >= width:
 *                 c1 = 0             # <<<<<<<<<<<<<<
 *                 # jumped_lr = True
 ...
 */
      ...
      /* "lib/measure/_find_tips_pbc_cy.pyx":238
 * 
 ...
 */
      ...
      /* "lib/measure/_find_tips_pbc_cy.pyx":239
 *             # Skip this square if any of the four input values are masked out.
 *             if use_mask and not (mask[r0, c0] and mask[r0, c1] and
 *                                  mask[r1, c0] and mask[r1, c1]):             # <<<<<<<<<<<<<<
 *                 continue
 ...
 */
      ...
      if (__pyx_t_15) {
        ...
        /* "lib/measure/_find_tips_pbc_cy.pyx":240
 *             if use_mask and not (mask[r0, c0] and mask[r0, c1] and
 *                                  mask[r1, c0] and mask[r1, c1]):
 *                 continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "lib/measure/_find_tips_pbc_cy.pyx":245
 *             #if none are found, continue
 *             ul1 = array1[r0, c0]
 *             ur1 = array1[r0, c1]             # <<<<<<<<<<<<<<
 *             ll1 = array1[r1, c0]
 ...
 */
      ...
      /* "lib/measure/_find_tips_pbc_cy.pyx":251
 *             square_case1 = 0
 *             if (ul1 > level1): square_case1 += 1
 *             if (ur1 > level1): square_case1 += 2             # <<<<<<<<<<<<<<
 *             if (ll1 > level1): square_case1 += 4
 ...
 */
      ...
      /* "lib/measure/_find_tips_pbc_cy.pyx":253
 *             if (ur1 > level1): square_case1 += 2
 *             if (ll1 > level1): square_case1 += 4
 *             if (lr1 > level1): square_case1 += 8             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "lib/measure/_find_tips_pbc_cy.pyx":262
 *             #find any segments for array2
 *             ul2 = array2[r0, c0]
 *             ur2 = array2[r0, c1]             # <<<<<<<<<<<<<<
 *             ll2 = array2[r1, c0]
 ...
 */
      ...
      /* "lib/measure/_find_tips_pbc_cy.pyx":267
 * 
 *             if (ul2 > level2): square_case2 += 1
 *             if (ur2 > level2): square_case2 += 2             # <<<<<<<<<<<<<<
 *             if (ll2 > level2): square_case2 += 4
 ...
 */
      ...
      /* "lib/measure/_find_tips_pbc_cy.pyx":269
 *             if (ur2 > level2): square_case2 += 2
 *             if (ll2 > level2): square_case2 += 4
 *             if (lr2 > level2): square_case2 += 8             # <<<<<<<<<<<<<<
 * 
 ...
 */
      switch (__pyx_v_square_case2) {
        ...
        /* "lib/measure/_find_tips_pbc_cy.pyx":274
 *                 # only do anything if there's a line passing through the
 *                 # square. Cases 0 and 15 are entirely below/above the contour.
 *                 continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "lib/measure/_find_tips_pbc_cy.pyx":278
 *             #a segment exists for both contour types
 *             #lookup segments
 ...
 */
      ...
      /* "lib/measure/_find_tips_pbc_cy.pyx":280
 *             segments1 = lookup_segments(ul1,ll1,ur1,lr1,r0,r1,c0,c1,level1,square_case1)
 *             # segments1 = compute_segments_in_window(ul1,ll1,ur1,ul1,level1,square_case1)
 *             segments2 = lookup_segments(ul2,ll2,ur2,lr2,r0,r1,c0,c1,level2,square_case2)             # <<<<<<<<<<<<<<
 *             # if len(segments1)==0:
 ...
 */
      ...
      /* "lib/measure/_find_tips_pbc_cy.pyx":287
 *             #     continue
 ...
 */
      ...
      for (;;) {
        ...
        /* "lib/measure/_find_tips_pbc_cy.pyx":288
 *             #up to 4 iterations may occur in this nested for loop
 *             for u in segments1:
 *                 for v in segments2:             # <<<<<<<<<<<<<<
 *                     #TODO: for each segment pair, check for an intersection point, if they exist, return the intersection ponts
 ...
 */
      ...
      /* "lib/measure/_find_tips_pbc_cy.pyx":293
 * 
 ...
 */
      ...
      if (__pyx_t_15) {
        ...
        /* "lib/measure/_find_tips_pbc_cy.pyx":294
 *             # Skip this square if any of the four input values are NaN.
 *             if npy_isnan(ul1) or npy_isnan(ur1) or npy_isnan(ll1) or npy_isnan(lr1):
 *                 continue             # <<<<<<<<<<<<<<
 * 
...
/* "lib/measure/_find_tips_pbc_cy.pyx":309
 * 
...
static PyObject *__pyx_pf_3lib_7measure_17_find_tips_pbc_cy_2lookup_segments(CYTHON_UNUSED PyObject *__pyx_self, double __pyx_v_ul, double __pyx_v_ll, double __pyx_v_ur, double __pyx_v_lr, int __pyx_v_r0, int __pyx_v_r1, int __pyx_v_c0, int __pyx_v_c1, double __pyx_v_level, int __pyx_v_square_case) {
  ...
  /* "lib/measure/_find_tips_pbc_cy.pyx":315
 *     segments1 = lookup_segments(ul1,ll1,ur1,lr1,r0,r1,c0,c1,level1,square_case1)'''
 * 
 *     cdef list segments = []             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_2 = PyFloat_FromDouble((__pyx_v_c0 + __pyx_f_3lib_7measure_17_find_tips_pbc_cy__get_fraction(__pyx_v_ul, __pyx_v_ur, __pyx_v_level))); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 339, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  /* "lib/measure/_find_tips_pbc_cy.pyx":340
 * 
 *     top    = r0, c0 + _get_fraction(ul, ur, level)
 *     bottom = r1, c0 + _get_fraction(ll, lr, level)             # <<<<<<<<<<<<<<
 *     left   = r0 + _get_fraction(ul, ll, level), c0
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = PyFloat_FromDouble((__pyx_v_c0 + __pyx_f_3lib_7measure_17_find_tips_pbc_cy__get_fraction(__pyx_v_ll, __pyx_v_lr, __pyx_v_level))); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 340, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  /* "lib/measure/_find_tips_pbc_cy.pyx":341
 *     top    = r0, c0 + _get_fraction(ul, ur, level)
 *     bottom = r1, c0 + _get_fraction(ll, lr, level)
 *     left   = r0 + _get_fraction(ul, ll, level), c0             # <<<<<<<<<<<<<<
 *     right  = r0 + _get_fraction(ur, lr, level), c1
 * 
 */
  __pyx_t_1 = PyFloat_FromDouble((__pyx_v_r0 + __pyx_f_3lib_7measure_17_find_tips_pbc_cy__get_fraction(__pyx_v_ul, __pyx_v_ll, __pyx_v_level))); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 341, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "lib/measure/_find_tips_pbc_cy.pyx":342
 *     bottom = r1, c0 + _get_fraction(ll, lr, level)
 *     left   = r0 + _get_fraction(ul, ll, level), c0
 *     right  = r0 + _get_fraction(ur, lr, level), c1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_3 = PyFloat_FromDouble((__pyx_v_r0 + __pyx_f_3lib_7measure_17_find_tips_pbc_cy__get_fraction(__pyx_v_ur, __pyx_v_lr, __pyx_v_level))); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 342, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
 ...
 */
    ...
    /* "lib/measure/_find_tips_pbc_cy.pyx":377
 *         # TODO: check that 0 < val is used instead of 0 > val for each case (use a simple test case!)
 *         vertex_connect_high = 0 > val
 *         if vertex_connect_high: #this ambiguity should be resolved with bilinear interpolation!!             # <<<<<<<<<<<<<<
 *             segments.append((left, top))
 ...
 */
    ...
    /* "lib/measure/_find_tips_pbc_cy.pyx":381
 *             segments.append((right, bottom))
 *         else:
 *             segments.append((right, top))             # <<<<<<<<<<<<<<
 *             segments.append((left, bottom))
 ...
 */
    ...
    /* "lib/measure/_find_tips_pbc_cy.pyx":372
 *         # top to bottom
 *         segments.append((top, bottom))
 *     elif (square_case == 6):             # <<<<<<<<<<<<<<
 *         # compute bilinear interpolation here as sign(face labelF(A)(F(A)F(C)F(B)F(D))) (Lewiner marching squares)
 ...
 */
    ...
    /* "lib/measure/_find_tips_pbc_cy.pyx":394
 *         # TODO: check that 0 < val is used instead of 0 > val for each case (use a simple test case!)
 *         vertex_connect_high = 0 < val
 *         if vertex_connect_high: #this ambiguity should be resolved with bilinear interpolation!!             # <<<<<<<<<<<<<<
 *             segments.append((top, right))
 ...
 */
    ...
    /* "lib/measure/_find_tips_pbc_cy.pyx":398
 *             segments.append((bottom, left))
 *         else:
 *             segments.append((top, left))             # <<<<<<<<<<<<<<
 *             segments.append((bottom, right))
 ...
 */
    ...
    /* "lib/measure/_find_tips_pbc_cy.pyx":389
 *         # bottom to right
 *         segments.append((bottom, right))
 *     elif (square_case == 9):             # <<<<<<<<<<<<<<
 *         # compute bilinear interpolation here as sign(face labelF(A)(F(A)F(C)F(B)F(D))) (Lewiner marching squares)
 ...
 */
    ...
    /* "lib/measure/_find_tips_pbc_cy.pyx":414
 *     elif (square_case == 14):
 *         # left to top
 *         segments.append((left, top))             # <<<<<<<<<<<<<<
 *     return segments
 ...
 */
  ...
  /* "lib/measure/_find_tips_pbc_cy.pyx":415
 *         # left to top
 *         segments.append((left, top))
 *     return segments             # <<<<<<<<<<<<<<
 */
 ...
 *     double level,int square_case):
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_3lib_7measure_17_find_tips_pbc_cy_3lookup_segments, NULL, __pyx_n_s_lib_measure__find_tips_pbc_cy); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 309, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
