...
def test_compute_arclength_values(node_id_lst,xy_values, s_values, contours):
...
def test_archlength_support(xy_values, node_id_lst,s_values,contours):
...
if __name__ == '__main__':
	...
	assert ( test_compute_arclength_values(node_id_lst,xy_values,s_values,contours) )
	assert ( test_archlength_support(xy_values, node_id_lst,s_values,contours) )
