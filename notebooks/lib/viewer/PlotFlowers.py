...
def PlotFlowerTrajectories(df,col="t",width=200,height=200,fontsize=24,DS = 5/200, DT=1., jump_thresh=10., alpha=0.01,saving = False, savefig_folder=None,savefig_fn=None):
